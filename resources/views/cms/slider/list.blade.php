...
<body>
    ...
    <main class="main" id="top">
        <div class="container-fluid px-0" data-layout="container">
            ...
            <div class="content">
                <h2 class="text-bold text-1100 mb-5">Sliders</h2>
                <div id="members"
                    ...
                    <div class="row align-items-center justify-content-between g-3 mb-3">
                            ...
                            <div class="search-box">
                                <form class="position-relative" data-bs-toggle="search" data-bs-display="static">
                                    <input class="form-control search-input search" type="search"
                                        placeholder="Search Sliders" id="searchvendor" name="searchvendor"
                                        aria-label="Search" />
                        ...
                        <div class="col-auto">
                            <div class="d-flex align-items-center"><button class="btn btn-link text-900 me-4 px-0"><button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#slideradded"><span class="fas fa-plus me-2"></span>Add Sliders</button></div>
                        </div>
                    </div>
                    <div
        ...
        @include('deactivate')
        <div class="modal fade" id="slideradded" tabindex="-1"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header" style="background-color: #ebecec;">
                        <h5 class="modal-title" id="verticallyCenteredModalLabel">Add Sliders</h5><button
                            class="btn p-1" type="button" data-bs-dismiss="modal" aria-label="Close"><span
                                class="fas fa-times fs--1"></span></button>
                    </div>
                    <input type="hidden" name="uri_value" id="uri_value" value="cms/sliders">
                    <div class="modal-body">
                       
                        <form class="row g-3" id="slideraddd" method="POST">
                            @csrf()
                            <div class="col-md-6">
    ...
    <div class="modal fade" id="slidermodel" tabindex="-1" aria-labelledby="verticallyCenteredModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #ebecec;">
                ...
                <div class="modal-body">
                    ...
                    <form class="row g-3" id="slider_update" method="post">
                        @csrf()
