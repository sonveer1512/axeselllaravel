                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="mb-4">
                                                ...
                                                <input type="text" name="title" id="title" class="form-control" placeholder="Enter Title" value="{{$faqs->title ?? ''}}">
                                            </div>
                                            <div class="mb-4">
                                                <label for="formFile" class="form-label">Description</label>
                                                <textarea type="text" name="editor1" id="editor1" class="form-control">{{$faqs->value ?? ''}}</textarea>
                                            </div>
                                            <div class="error" id="error_editor"></div>
                                        </div>
                                    </div>
                                    <input type="hidden" name="id" id="id" value="{{ getuserdetail('id') }}">
                                    <input type="hidden" name="type" id="type" value="faqs">
