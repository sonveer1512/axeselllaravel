                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="mb-4">
                                                ...
                                                <input type="text" name="title" id="title" class="form-control" placeholder="Enter Title" value="{{$refund->title ?? ''}}">
                                            </div>
                                            <div class="mb-4">
                                                <label for="formFile" class="form-label">Description</label>
                                                <textarea type="text" name="editor1" id="editor1" class="form-control">{{$refund->value ?? ''}}</textarea>
                                            </div>
                                            <div class="error" id="error_editor"></div>
                                        </div>
                                    </div>
                                    <input type="hidden" name="id" id="id" value="{{ getuserdetail('id') }}">
                                    <input type="hidden" name="type" id="type" value="Refund_Policy">
...
<script>
    $(document).on('submit', '#aboutupdate', function(ev) {
        ...
        if (error == false) {
            $.ajax({
                url: base_url + 'cms/refund/update',
                type: 'post',
                data: formData,
                cache: false,
                contentType: false,
