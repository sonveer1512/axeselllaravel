...
<body>
    ...
    <main class="main" id="top">
        <div class="container-fluid px-0" data-layout="container">
            ...
            <div class="content">
                <h2 class="text-bold text-1100 mb-5">Blogs</h2>
                <div id="members"
                    ...
                    <div class="row align-items-center justify-content-between g-3 mb-3">
                            ...
                            <div class="search-box">
                                <form class="position-relative" data-bs-toggle="search" data-bs-display="static">
                                    <input class="form-control search-input search" type="search"
                                        placeholder="Search Blog" id="searchblog" name="searchblog"
                                        aria-label="Search" />
                        ...
                        <div class="col-auto">
                            <div class="d-flex align-items-center"><button class="btn btn-link text-900 me-4 px-0"><button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#vendoradded"><span class="fas fa-plus me-2"></span>Add Blogs</button></div>
                        </div>
                    </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header" style="background-color: #ebecec;">
                        <h5 class="modal-title" id="verticallyCenteredModalLabel">Add Blog</h5><button class="btn p-1" type="button" data-bs-dismiss="modal" aria-label="Close"><span class="fas fa-times fs--1"></span></button>
                    </div>
                    <input type="hidden" name="uri_value" id="uri_value" value="cms/blogs">
                    <div class="modal-body">
                        <div id="addnew">
                            <form class="row g-3" id="blogadded" method="POST">
                                @csrf()
                                <div class="col-md-6">
                                    <div class="form-floating mb-2 mt-2">
                                        <input class="form-control brand_name" id="title" type="text" name="title">
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea class="form-control" id="metatags" placeholder="Leave a comment here" style="height: 100px" name="metatags"></textarea>
    ...
    <div class="modal fade" id="blogeditmodel" tabindex="-1" aria-labelledby="verticallyCenteredModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #ebecec;">
                    <h5 class="modal-title" id="verticallyCenteredModalLabel">Edit Blog</h5><button class="btn p-1" class="fas fa-times fs--1"></span></button>
                </div>
                <div class="modal-body">
                    <h4 class="text-center" style="color:#818787;">Contact Details</h4>
                    <form class="row g-3" id="blog_update" method="post">
                        @csrf()
                        <div id="blogedit"></div>
                        <div class="modal-footer"style="background-color: #ebecec;">
