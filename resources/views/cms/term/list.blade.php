                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="termsupdate" method="post">
                                    @csrf()
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="mb-4">
                                                <label class="form-label" for="exampleFormControlInput1">Title</label>
                                                <input type="text" name="title" id="title" class="form-control" placeholder="Enter Title" value="{{$terms->title ?? ''}}">
                                            </div>
                                            <div class="mb-4">
                                                <label class="form-label" for="exampleFormControlInput1">Description</label>
                                                <textarea type="text" name="editor1" id="editor1" class="form-control">{{$terms->value ?? ''}}</textarea>
                                            </div>
                                            <div class="error" id="error_editor"></div>
                                        </div>
                                    </div>
                                    <input type="hidden" name="id" id="id" value="{{ getuserdetail('id') }}">
                                    <input type="hidden" name="type" id="type" value="Terms_condition">
...
<script>
    $(document).on('submit', '#termsupdate', function(ev) {
        $('.error').html('');
